...
class PIMKernel
{
  public:
    ...
    */
    ...
    void executeJoinBench(int dim0, int dim1, pimBankType bank_types, KernelType ktype, int input0_row,
        int input1_row);

    std::vector<int> make_tuples(std::size_t n, int is_uniform = 1, std::size_t chunk_size = 128, double bias = 1.0/16);
