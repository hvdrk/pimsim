                            ...
                            BurstType* result)
    {
        switch (kn_type)
        {
            ...
            case KernelType::JOIN:
            {
                ...
                // std::cout << "dim_data->input_npbst_.getTotalDim() : " << dim_data->input_npbst_.getTotalDim() << std::endl;
                ...
                kernel->executeJoinBench(dim_data->input_npbst_.getTotalDim(), dim_data->input1_npbst_.getTotalDim(),
                                              pimBankType::ALL_BANK, kn_type, input_row0, input_row1);
